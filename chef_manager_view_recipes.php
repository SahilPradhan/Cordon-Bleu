...
<body>
	<div class="hero">
		...
		<input type="submit" name="viewdata" id="viewdata" value="Recipe details" class="btn btn-success">	
	</div>
				</div>
				<div class="col">
					<div id="submit" align="center">
		<input type="submit" name="viewlogs" id="viewdata" value="View Logs" class="btn btn-info">	
				...
				$name = $_POST["name1"];
                                $email = $_SESSION['email'];
				$query = "select ingredients,qty,unit from recipe_details where name='$name' and email='$email'";			//Query execution
