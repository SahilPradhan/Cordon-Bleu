			...
			<div class="row" id="btn1">
				<div class="col">
					<div class="form-group mybtn">
						<a href="inv_manager_view_inventory.php" name="btn-view" class="btn btn-dark form-control ">View inventory</a>
					</div>
				</div>
				<div class="col">
					<div class="form-group">
						<a href="inv_manager_add_inventory.php" name="btn-add" class="btn btn-light form-control mybtn" >Add new inventory</a>
					</div>
				</div>
				<div class="col">
					<div class="form-group">
						<a href="inv_manager_update_inventory.php" name="btn-update" class="btn btn-dark form-control mybtn" >Update inventory</a>
					</div>
				</div>
				<div class="col">
					<div class="form-group">
						<a href="inv_manager_delete_inventory.php" name="btn-delete" class="btn btn-light form-control mybtn" >Delete inventory</a>
					</div>
				</div>
			</div>
		</div>
