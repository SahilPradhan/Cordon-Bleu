...
$query2 = "select ingredients from inventory_details";
...
if(isset($_POST['submit']))
{
	...
	$query="update inventory_details set qty=$qty where ingredients='$ingredients'";
		...
		<div class="inv_manager_update_inventory-inputs">
			<form method="post">
				<div class="row">
					...
					<div class="col">
						<div class="form-group">
							<input type="number" name="qty" min="0" required class="form-control" placeholder="Quantity">
						</div>
					</div>
					<div class="col">
						<div class="form-group">
			...
			<!-- SUBMIT BUTTON -->
			<div class="submit-inputs" id="submit" align="center">
