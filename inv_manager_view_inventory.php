...
<head>
	...
	<script>
			/*	function showCustomer(str) {
					...
					xhttp.open("GET", "inv_manager_view_inventory.php", true);
					xhttp.send();
	...
	<div class="hero">
		...
		<div class="header">
			...
			<div>
				...
				$query = "select* from inventory_details where email='$email'";			//Query execution
				...
				if ($result->num_rows > 0) {
					...
					$output = "Inventory currently unavailable. Please try again.";
					echo $output;
				}	
...
<div class="submit-inputs">
	<div class="row">
		<div class="col">
			<div class="form-group" id="submit" align="center">
				<a href="inv_manager_update_inventory.php"><input type="button" name="submit" class="form-control btn btn-success" value="Update Inventory"></a>	
			</div>
		</div>
		<div class="col">
			<div class="form-group" id="updatedata" align="center">
				<a href="inv_manager_2.php"><input type="button" name="updatedata" class="form-control btn btn-info" value="Inventory Manager"></a>	
			</div>
		</div>
	</div>		
</div>
